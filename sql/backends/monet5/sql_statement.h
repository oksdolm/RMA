...
extern stmt *stmt_atom_double(backend *be, double i);
...
extern stmt *stmt_lapack(backend *be, list *l, int attrcnt);

extern stmt *stmt_ewmul(backend *be, stmt *op1, stmt *op2);
extern stmt *stmt_ewsub(backend *be, stmt *op1, stmt *op2);
extern stmt *stmt_ewdiv(backend *be, stmt *op1, stmt *op2);
extern stmt *stmt_ewadd(backend *be, stmt *op1, stmt *op2);
extern stmt *stmt_norm(backend *be, stmt *op1);
extern stmt *stmt_innorm(backend *be, stmt *op1, stmt *op2);


extern stmt *stmt_sum(backend *be, stmt *op1);
extern stmt *stmt_sel(backend *be, stmt *op1, stmt *op2);
