...
|  '(' table_ref ON selection opt_order_by_clause ')' SOL '(' table_ref ON selection opt_order_by_clause ')'
	{ dlist *l = L();
	  append_symbol(l, $2);
	  append_symbol(l, $5);
	  append_list(l, $4);
	  ...
	  append_symbol(l, $12);
	  append_list(l, $11);
	  $$ = _symbol_create_list( SQL_MATRIXSOL, l); }

|  '(' table_ref ON selection opt_order_by_clause ')' CPD '(' table_ref ON selection opt_order_by_clause ')'
	{ dlist *l = L();
	  append_symbol(l, $2);
	  append_symbol(l, $5);
	  append_list(l, $4);
...
|  '(' table_ref ON selection opt_order_by_clause ')' ADD '(' table_ref ON selection opt_order_by_clause ')'
 ...
 |  QQR '(' table_ref ON selection opt_order_by_clause ')'
	{ dlist *l = L();
	  append_symbol(l, $3);
	  append_symbol(l, $6);
	  append_list(l, $5);
 ...
 |  LAPACK '(' table_ref ON selection opt_order_by_clause ')'
	{ dlist *l = L();
	  append_symbol(l, $3);
	  append_symbol(l, $6);
	  append_list(l, $5);
	  $$ = _symbol_create_list( SQL_LAPACK, l); }
...
opt_order_by_clause:
 ...
 |  BY sort_specification_list
		{ $$ = _symbol_create_list( SQL_ORDERBY, $2); }		
 ;
