...
sql_rel *
rel_lapack(sql_allocator *sa, sql_rel *l)
{
	sql_rel *rel = rel_create(sa);

	fprintf(stderr, "rel_lapack \n");
...
sql_rel *
rel_matrixsol(sql_allocator *sa, sql_rel *l, sql_rel *r)
{
	sql_rel *rel = rel_create(sa);

	fprintf(stderr, "rel_matrixsol \n");
...
sql_rel *
rel_matrixcpd(sql_allocator *sa, sql_rel *l, sql_rel *r)
{
	sql_rel *rel = rel_create(sa);
